...
import com.easy.social.app.R;
import com.easy.social.app.SquareFragment.ImageInfo;
...
public class MyPagerAdapter extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, final int index) {
		...
		View view = activity.getLayoutInflater().inflate(R.layout.square_grid, null);
		...
		gridView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				View item = LayoutInflater.from(activity).inflate(
						R.layout.square_grid_item, null);
